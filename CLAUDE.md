...
### **バックアップ・復旧**
```bash
# 削除されたファイルの復旧（GitHubベース）
git checkout v0.3.0-beta.2 -- examples/
git checkout v0.3.0-beta.2 -- tests/
git checkout v0.3.0-beta.2 -- scripts/verify_v030_integration.py
